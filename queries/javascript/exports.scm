;; ═══════════════════════════════════════════════════════════════════════════
;; JavaScript/TypeScript Export Queries
;; ═══════════════════════════════════════════════════════════════════════════
;;
;; These queries detect export statements for cross-module env var tracking.
;; Captures:
...
(export_statement
  ...
  (#not-kind? @export_value "identifier")) @default_export
