...
#[tokio::test]
async fn test_cpp_hover_getenv() {
    let fixture = TestFixture::new().await;
    let uri = fixture.create_file("main.cpp", r#"getenv("DB_URL")"#);
...
#[tokio::test]
async fn test_cpp_hover_std_getenv() {
    let fixture = TestFixture::new().await;
    let uri = fixture.create_file("main.cpp", r#"std::getenv("API_KEY")"#);
    ...
    fixture
        ...
        .open(
            uri.clone(),
            "cpp".to_string(),
            r#"std::getenv("API_KEY")"#.to_string(),
            0,
        )
        .await;
    ...
    assert!(hover.is_some(), "Expected hover for std::getenv");
    assert!(format!("{:?}", hover.unwrap()).contains("secret_key"));
}

#[tokio::test]
async fn test_cpp_diagnostics_undefined() {
    let fixture = TestFixture::new().await;
    let uri = fixture.create_file("main.cpp", r#"getenv("UNDEFINED_VAR")"#);
